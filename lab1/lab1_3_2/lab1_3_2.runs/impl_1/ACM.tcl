...
set rc [catch {
  ...
  open_checkpoint ACM_routed.dcp
  set_property webtalk.parent_dir D:/gyx_uni/2_spring/cod/lab/lab1/lab1_3_2/lab1_3_2.cache/wt [current_project]
  catch { write_mem_info -force ACM.mmi }
  write_bitstream -force ACM.bit 
  catch {write_debug_probes -quiet -force ACM}
  catch {file copy -force ACM.ltx debug_nets.ltx}
