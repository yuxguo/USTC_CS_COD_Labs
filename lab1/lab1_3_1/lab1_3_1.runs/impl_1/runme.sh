...
HD_PWD='D:/gyx_uni/2_spring/cod/lab/lab1/lab1_3_1/lab1_3_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CMP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CMP.tcl -notrace
